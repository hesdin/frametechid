    ...
    >
        ...
        >
            <div class="mx-auto max-w-[860px] text-center">
                ...
                <p
                    class="mx-auto mt-5 max-w-[780px] text-[15px] leading-[1.7] text-[#6d7390] md:text-[16px]"
                >
                    Pilih paket yang paling cocok dengan kebutuhan, target
                    pertumbuhan, dan tingkat kompleksitas website bisnismu.
                </p>
            </div>
            ...
            <div class="mt-12 grid gap-6 lg:grid-cols-3">
                <article
                    ...
                    :key="plan.name"
                    class="flex h-full flex-col rounded-[26px] border border-[#dce8f4] bg-white px-7 py-8 shadow-[0_14px_26px_rgba(31,91,143,0.08)]"
                >
                    <span
                        :class="[
                    ...
                    <h3
                        class="mt-5 text-[18px] leading-tight font-semibold text-[#2a2e49]"
                    >
                        {{ plan.name }}
                    </h3>
                    <p
                        class="mt-3 text-[14px] leading-[1.75] text-[#6e7691] md:text-[15px]"
                    >
                        {{ plan.summary }}
                    </p>
                    ...
                    <div class="mt-6">
                        <p
                            class="text-[13px] text-[#9aa1b4] line-through md:text-[14px]"
                        >
                            {{ plan.previousPrice }}
                        </p>
                        <div class="mt-2 flex items-center gap-3">
                            <strong
                                class="text-[24px] leading-none font-semibold text-[#1f79bc]"
                            >
                                {{ plan.price }}
                            </strong>
                            <span
                                class="rounded-full bg-[#fff5e5] px-3 py-1 text-[12px] font-semibold text-[#de8a00]"
                            >
                                {{ plan.discount }}
                            </span>
                        </div>
                        <p class="mt-3 text-[13px] text-[#7a8096]">
                            {{ plan.note }}
                        </p>
                    </div>
                    ...
                    <ul class="mt-7 grid gap-3">
                        <li
                            ...
                            :key="feature"
                            class="inline-flex items-start gap-3 rounded-[12px] bg-[#eef5fc] px-4 py-3 text-[14px] leading-[1.55] text-[#4a5269]"
                        >
                            <span
                    ...
                    <details class="mt-5 border-t border-[#eceff4] pt-5">
                        <summary
                            class="flex cursor-pointer list-none items-center justify-between text-[14px] font-medium text-[#6e7691]"
                        >
                        ...
                        <p
                            class="mt-4 text-[14px] leading-[1.7] text-[#7b8097]"
                        >
                            Detail final paket akan disesuaikan dengan struktur
                            halaman, jumlah konten, dan kebutuhan bisnismu.
                        </p>
                    </details>
