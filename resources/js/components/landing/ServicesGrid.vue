...
<template>
    <section
        id="layanan"
        class="bg-[linear-gradient(180deg,#f5f9fd_0%,#ffffff_100%)] py-24 md:py-28"
    >
        <div
        ...
        >
            ...
            <div class="mt-12 grid gap-6 md:grid-cols-2 xl:grid-cols-3">
                <article
                    ...
                    :key="service.title"
                    class="rounded-[22px] border border-[#dce8f4] bg-white px-7 py-8 text-center shadow-[0_14px_26px_rgba(31,91,143,0.08)]"
                >
                    <span
                    ...
                    <h3
                        class="mt-6 text-[17px] leading-[1.4] font-semibold text-[#2a2e49] md:text-[18px]"
                    >
                        {{ service.title }}
                    </h3>
                    <p
                        class="mt-4 text-[14px] leading-[1.75] text-[#6e7691] md:text-[15px]"
                    >
                        {{ service.description }}
                    </p>
                </article>
